...
function cargarProductos(productosElegidos) {
    ...
    productosElegidos.forEach(producto => {
        ...
        let className
        if (producto.categoria.nombre === "Juegos"){
            className="caratula"
        } else if (producto.categoria.nombre === "Consolas"){
            className="consola"
        } else{
        ...
        div.innerHTML = `
            <img class="producto-imagen ${className}" src="${producto.imagen}" alt="${producto.titulo}">
